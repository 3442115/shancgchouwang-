package com.atguigu.srping.cloud.controller;
...
public class EmployeeController {
    ...
    public Employee getEmployee(){
        return new Employee(1,"gf21",25123.0);
    }
    ...
    public ResultEntity<Employee> getEmployByCr(@RequestParam("keyword") String keyword){
        ...
        return ResultEntity.successWithData(new Employee(123,"gfwsadasdascs",54516.0));
    }
